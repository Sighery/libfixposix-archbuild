# Automated Arch Linux package for libfixposix
...
[AUR entry][AUR libfixposix]. AUR entries are just Git repositories.
...
[AUR libfixposix]: https://aur.archlinux.org/packages/libfixposix/
